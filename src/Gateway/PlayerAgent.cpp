...
void UAgentContext::SetPlayerID(int64_t pid) {
    mPlayerID = pid;
}

void UAgentContext::SetConnectionID(int64_t cid) {
    mConnectionID = cid;
}
...
void IPlayerAgent::SendToClient(int64_t pid, const std::shared_ptr<IPackage> &pkg) const {
